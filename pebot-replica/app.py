...
from dialogs import MainDialog, SearchDialog, ReportDialog
...
RECOGNIZER = IntelliOpsRecognizer(CONFIG)
SEARCH_DIALOG = SearchDialog()
REPORT_DIALOG = ReportDialog()
DIALOG = MainDialog(RECOGNIZER, SEARCH_DIALOG, REPORT_DIALOG)
